...
-- 주방용품
INSERT INTO ITEM (name, description, brand_name, price, package_type, origin, model_serial_no, stock, is_oneday_eligible)
VALUES (
...
-- 홈 인테리어
INSERT INTO ITEM (name, description, brand_name, price, dimension, model_serial_no, stock, is_oneday_eligible)
VALUES (
           '코멧 모던스타일 테이블', '목제 상판에 알루미늄 받침대', '코멧', 19890, '790x590(mm)', '2354065065 - 4084109222', 22, true
       );

-- 가전 디지털
INSERT INTO ITEM (name, description, brand_name, price, dimension, package_type, origin, model_serial_no, search_keyword, stock, is_oneday_eligible)
VALUES (
...
-- 도서
INSERT INTO ITEM (name, description, price, package_type, search_keyword, stock, author, publisher, isbn, published_time, is_oneday_eligible)
VALUES (
...
-- 문구
INSERT INTO ITEM (name, description, brand_name, price, package_type, stock, origin, is_oneday_eligible)
VALUES (
