...
public class DeliveryService {
	...
	public DeliveryApiResult findDeliveryApiResultByDeliveryId(Long deliveryId) {
		...
		DeliveryDriver deliveryDriver = deliveryDriverService.findById(deliveryDriverId);
		 ...
		 return new DeliveryApiResult(delivery, deliveryPolicy);
	}
	...
	@Transactional
	public void updateStatus(StatusRequest requestDTO) {
	...
	@Transactional
	public Delivery updateStatus(Long deliveryId, Status status) {
		updateStatus(new StatusRequest(deliveryId, status));
